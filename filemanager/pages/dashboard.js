  ...
  return (
		  ...
		  <div className="grid overflow-hidden lg grid-cols-2 grid-rows-2 gap-4 w-full mb-10">
				<div className="box flex flex-col items-center">
					<span className="flex-1 font-bold text-xl mt-2">Total Files in Network</span>
					<h1 className="flex-1 font-bold text-4xl ">{totalFiles}</h1>
				</div>
				<div className="box flex flex-col items-center">
					<span className="flex-1 font-bold text-xl mt-2">Current Network Size</span>
					<h1 className="flex-1 font-bold text-4xl ">{totalFileSize/1000}KB</h1>
				</div>
				<div className="box flex flex-col items-center">
				...
				<div className="box flex flex-col items-center">
					<span className="flex-1 font-bold text-xl mt-2">Your Current Space</span>
					<h1 className="flex-1 font-bold text-4xl ">{userFileSize/1000}KB</h1>
				</div>
		  </div>
		  <div className="mt-10 grid overflow-hidden lg grid-cols-4 grid-rows-2 gap-4 w-full h-auto">
  		  ...
  		  <h1 className="text-xl font-bold ">Uploaded Size Stats:</h1>
				...
				<div className=" row-span-2 col-span-2">
  		  <h1 className="text-xl font-bold ">Number of Files Uploaded Stats:</h1>
